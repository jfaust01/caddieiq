...
import { BarChart3, Clock, Shield, Star, TrendingUp, Activity, ChevronDown } from 'lucide-react'
    ...
    >
      ...
      <div className="relative z-10">
        ...
        <button
          ...
          aria-controls="field-strength-content"
        >
          <div className="flex flex-col gap-6 px-6 py-8 sm:flex-row sm:items-center sm:justify-between sm:gap-4">
            ...
            <div className="flex flex-col items-start gap-2 sm:items-end sm:flex-1">
