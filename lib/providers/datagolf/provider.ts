/**
 * DataGolf provider — scaffold only.
 *
...
export class DataGolfProvider extends BaseProvider<unknown, unknown> {
  ...
  async health(): Promise<ProviderStatus> {
    return {
      ...
      checkedAt: new Date(),
      message: "DataGolf provider is a scaffold; not yet implemented.",
    }
  }
